...
<div class="panel panel-default">
  <div class="panel-heading">
    <h3 class="panel-title">Decentralization</h3>
  </div>
  <div class="panel-body">

  <?php if($role_signin_id == "r01"): ?>
	 	 <div>
	   		<button type="button" class="btn btn-default btn_infor"  data-id="r02">
	   				<?php echo $role_name_pm ;?>
	   		</button>
	   		<button type="button" class="btn btn-default btn_infor"  data-id="r04">
